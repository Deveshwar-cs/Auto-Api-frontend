          ...
          <div className="space-y-4">
            {projects.map((project) => (
              <div
                ...
                className="flex items-center justify-between p-4 rounded-xl bg-white dark:bg-[#1B1330] hover:bg-slate-50 dark:hover:bg-[#241A40] transition cursor-pointer border border-slate-200 dark:border-purple-900/20 group shadow-sm dark:shadow-none"
              >
                {/* Left */}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-xs text-purple-600 dark:text-purple-400 group-hover:translate-x-1 transition">
                    Open →
                  </div>
                </div>
              </div>
