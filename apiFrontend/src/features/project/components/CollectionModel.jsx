...
const CollectionModal = ({onClose}) => {
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
      {/* Modal Container */}
      <div className="w-306 max-h-[90vh] bg-white dark:bg-[#1B1330] border border-slate-200 dark:border-purple-900/20 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        {/* Header */}
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto p-6 bg-white dark:bg-[#1B1330]">
